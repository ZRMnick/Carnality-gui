...
-- Title Bar (Green Look)
local TitleBar = Instance.new("Frame")
TitleBar.Size = UDim2.new(1, 0, 0, 40)
TitleBar.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
TitleLabel.Text = "Carnality GUI | V0.5 (Dev Version)" -- Updated to Dev Version
...
-- Toggle Button (Green Look)
local ToggleButton = Instance.new("TextButton")
ToggleButton.Size = UDim2.new(0, 30, 0, 30)
ToggleButton.Position = UDim2.new(1, -70, 0, 5)
ToggleButton.Text = "X"
ToggleButton.BackgroundColor3 = Color3.fromRGB(0, 200, 0) -- Darker Green
...
-- Floating Toggle Button (Green Look, New Emoji)
local FloatingButton = Instance.new("TextButton")
FloatingButton.Size = UDim2.new(0, 50, 0, 50)
FloatingButton.Position = UDim2.new(0, 10, 0, 10)
FloatingButton.Text = "♻️" -- New Emoji
FloatingButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
addCategoryButton("Credits", 10, function()
    ...
    CreditsText.Text = "Scripted by: C00lshIn3\n GIVEN ONLY TO DEVELOPERS OF CARNALITY AND TESTERS!"
...
addCategoryButton("Code Executor", 50, function()
    ...
    ExecuteButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
addCategoryButton("Hacks", 90, function()
    ...
    local function addHackButton(text, posY, callback)
        ...
        Button.MouseEnter:Connect(function()
            Button.BackgroundColor3 = Color3.fromRGB(50, 255, 50) -- Lighter Green
        end)
        Button.MouseLeave:Connect(function()
            Button.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
        end)
    ...
    -- Hack 1: Speed Hack with Slider (Green Look)
    ...
    SpeedSliderFill.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
    ...
    KillButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
    ...
    TPButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
addCategoryButton("Visuals", 130, function()
    ...
    -- Function to add a visuals button (Green Look)
        ...
        if espEnabled then
            for _, player in pairs(Players:GetPlayers()) do
                if player ~= LocalPlayer and player.Character then
                    ...
                    highlight.FillColor = Color3.fromRGB(0, 255, 0) -- Lime Green
                ...
                if player ~= LocalPlayer and player.Character then
                    for _, part in pairs(player.Character:GetChildren()) do
                        if part:IsA("BasePart") then
                            ...
                            frame.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
addCategoryButton("Exploits", 170, function()
    ...
    -- Function to add an exploit button (Green Look)
    ...
    ChatSpamButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
...
addCategoryButton("Fun", 210, function()
    ...
    -- Function to add a fun button (Green Look)
...
-- Category: OP Hacks (New Category for Dev Version)
addCategoryButton("OP Hacks", 250, function()
    ContentFrame.Visible = true

    local OPHacksContent = Instance.new("Frame")
    OPHacksContent.Size = UDim2.new(1, 0, 1, 0)
    OPHacksContent.BackgroundTransparency = 1
    OPHacksContent.ZIndex = 3
    OPHacksContent.Parent = ContentFrame

    local OPHacksTitle = Instance.new("TextLabel")
    OPHacksTitle.Size = UDim2.new(0.9, 0, 0, 30)
    OPHacksTitle.Position = UDim2.new(0.05, 0, 0, 10)
    OPHacksTitle.Text = "OP Hacks"
    OPHacksTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    OPHacksTitle.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
    OPHacksTitle.TextScaled = true
    OPHacksTitle.ZIndex = 4
    OPHacksTitle.Parent = OPHacksContent

    local OPHacksTitleCorner = Instance.new("UICorner")
    OPHacksTitleCorner.CornerRadius = UDim.new(0, 4)
    OPHacksTitleCorner.Parent = OPHacksTitle

    -- Scrolling Frame for OP Hacks
    local OPHacksScroll = Instance.new("ScrollingFrame")
    OPHacksScroll.Size = UDim2.new(0.9, 0, 0, 230)
    OPHacksScroll.Position = UDim2.new(0.05, 0, 0, 50)
    OPHacksScroll.BackgroundTransparency = 1
    OPHacksScroll.ScrollBarThickness = 4
    OPHacksScroll.CanvasSize = UDim2.new(0, 0, 0, 150)
    OPHacksScroll.ZIndex = 4
    OPHacksScroll.Parent = OPHacksContent

    -- Function to add an OP hack button (Green Look)
    local function addOPHacksButton(text, posY, callback)
        local Button = Instance.new("TextButton")
        Button.Size = UDim2.new(0.95, 0, 0, 30)
        Button.Position = UDim2.new(0.025, 0, 0, posY)
        Button.Text = text
        ...
        Button.MouseButton1Click:Connect(function()
            ...
            local success, err = pcall(callback)
            if not success then
                warn("OP Hack '" .. text .. "' failed: " .. tostring(err))
            end
        end)
    end

    -- OP Hack 1: Mass Kill
    addOPHacksButton("Mass Kill", 0, function()
        for _, player in pairs(Players:GetPlayers()) do
            if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("Humanoid") then
                player.Character.Humanoid.Health = 0
            end
        end
        print("Mass Kill executed, Alpha! 💀💀💀")
    end)

    -- OP Hack 2: Server Shutdown
    addOPHacksButton("Server Shutdown", 35, function()
        warn("Server Shutdown activated. Use with caution!")
        for i = 1, 1000 do
            pcall(function()
                game:GetService("ReplicatedStorage"):WaitForChild("RemoteEvents").Shutdown:FireServer()
            end)
        end
        print("Server Shutdown executed, Alpha! 🛑")
    end)

    -- OP Hack 3: Infinite Yield
    addOPHacksButton("Infinite Yield", 70, function()
        local humanoid = Character:FindFirstChild("Humanoid")
        if humanoid then
            ...
            print("Infinite Yield enabled, Alpha! 💪")
        else
            warn("Infinite Yield failed: Humanoid not found.")
        end
    end)

    print("OP Hacks category loaded.")
end)

-- Category: Backdoor Scanner (New Category for Dev Version)
addCategoryButton("Backdoor Scanner", 290, function()
    ContentFrame.Visible = true

    local BackdoorContent = Instance.new("Frame")
    BackdoorContent.Size = UDim2.new(1, 0, 1, 0)
    BackdoorContent.BackgroundTransparency = 1
    BackdoorContent.ZIndex = 3
    BackdoorContent.Parent = ContentFrame

    local BackdoorTitle = Instance.new("TextLabel")
    BackdoorTitle.Size = UDim2.new(0.9, 0, 0, 30)
    BackdoorTitle.Position = UDim2.new(0.05, 0, 0, 10)
    BackdoorTitle.Text = "Backdoor Scanner"
    BackdoorTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    BackdoorTitle.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
    BackdoorTitle.TextScaled = true
    BackdoorTitle.ZIndex = 4
    BackdoorTitle.Parent = BackdoorContent

    local BackdoorTitleCorner = Instance.new("UICorner")
    BackdoorTitleCorner.CornerRadius = UDim.new(0, 4)
    BackdoorTitleCorner.Parent = BackdoorTitle

    -- Scrolling Frame for Backdoor Scanner
    local BackdoorScroll = Instance.new("ScrollingFrame")
    BackdoorScroll.Size = UDim2.new(0.9, 0, 0, 230)
    BackdoorScroll.Position = UDim2.new(0.05, 0, 0, 50)
    BackdoorScroll.BackgroundTransparency = 1
    BackdoorScroll.ScrollBarThickness = 4
    BackdoorScroll.CanvasSize = UDim2.new(0, 0, 0, 300)
    BackdoorScroll.ZIndex = 4
    BackdoorScroll.Parent = BackdoorContent

    -- Function to add a backdoor button (Green Look)
    local function addBackdoorButton(text, posY, callback)
        local Button = Instance.new("TextButton")
        Button.Size = UDim2.new(0.95, 0, 0, 30)
        Button.Position = UDim2.new(0.025, 0, 0, posY)
        Button.Text = text
        ...
        Button.MouseButton1Click:Connect(function()
            ...
            local success, err = pcall(callback)
            if not success then
                warn("Backdoor '" .. text .. "' failed: " .. tostring(err))
            end
        end)
    end

    -- Backdoor Scanner: Scan for Backdoors
    local backdoorFound = false
    local backdoorRemote = nil
    addBackdoorButton("Scan for Backdoors", 0, function()
        backdoorFound = false
        backdoorRemote = nil
        local statusLabel = BackdoorScroll:FindFirstChild("StatusLabel")
        if statusLabel then
            statusLabel.Text = "Status: Scanning..."
        end

        -- Attempt to find a backdoor by firing a test remote event
        for _, remote in pairs(ReplicatedStorage:GetDescendants()) do
            if remote:IsA("RemoteEvent") then
                local success, result = pcall(function()
                    remote:FireServer("test_backdoor")
                end)
                if success then
                    backdoorFound = true
                    ...
                    print("Backdoor found: " .. remote.Name .. ", Alpha! 🔓")
                    break
                end
            end
        end
        ...
        if not backdoorFound then
            ...
            print("No backdoor found, Alpha! 🔒")
        end
    end)

    -- Backdoor Executor: Execute Server-Side Code
    local BackdoorFrame = Instance.new("Frame")
    BackdoorFrame.Size = UDim2.new(0.95, 0, 0, 200)
    BackdoorFrame.Position = UDim2.new(0.025, 0, 0, 35)
    BackdoorFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
    BackdoorFrame.ZIndex = 5
    BackdoorFrame.Parent = BackdoorScroll

    local BackdoorFrameCorner = Instance.new("UICorner")
    BackdoorFrameCorner.CornerRadius = UDim.new(0, 4)
    BackdoorFrameCorner.Parent = BackdoorFrame

    local BackdoorCodeBox = Instance.new("TextBox")
    BackdoorCodeBox.Size = UDim2.new(0.9, 0, 0, 120)
    BackdoorCodeBox.Position = UDim2.new(0.05, 0, 0, 10)
    BackdoorCodeBox.Text = "Enter server-side code here..."
    BackdoorCodeBox.TextColor3 = Color3.fromRGB(255, 255, 255)
    BackdoorCodeBox.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
    BackdoorCodeBox.TextScaled = true
    BackdoorCodeBox.TextWrapped = true
    BackdoorCodeBox.ClearTextOnFocus = true
    BackdoorCodeBox.MultiLine = true
    BackdoorCodeBox.ZIndex = 6
    BackdoorCodeBox.Parent = BackdoorFrame

    local BackdoorCodeBoxCorner = Instance.new("UICorner")
    BackdoorCodeBoxCorner.CornerRadius = UDim.new(0, 4)
    BackdoorCodeBoxCorner.Parent = BackdoorCodeBox

    local BackdoorExecuteButton = Instance.new("TextButton")
    BackdoorExecuteButton.Size = UDim2.new(0.9, 0, 0, 30)
    BackdoorExecuteButton.Position = UDim2.new(0.05, 0, 0, 140)
    BackdoorExecuteButton.Text = "Execute Server-Side"
    BackdoorExecuteButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Lime Green
    BackdoorExecuteButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    BackdoorExecuteButton.TextScaled = true
    BackdoorExecuteButton.ZIndex = 6
    BackdoorExecuteButton.Parent = BackdoorFrame

    local BackdoorExecuteButtonCorner = Instance.new("UICorner")
    BackdoorExecuteButtonCorner.CornerRadius = UDim.new(0, 4)
    BackdoorExecuteButtonCorner.Parent = BackdoorExecuteButton
    ...
    StatusLabel.Parent = BackdoorFrame

    BackdoorExecuteButton.MouseButton1Click:Connect(function()
        if not backdoorFound or not backdoorRemote then
            StatusLabel.Text = "Status: No Backdoor Found!"
            warn("Cannot execute: No backdoor found.")
            return
        end

        local code = BackdoorCodeBox.Text
        local success, result = pcall(function()
            -- Attempt to execute the code server-side via the backdoor
            backdoorRemote:FireServer(code)
            StatusLabel.Text = "Status: Backdoor Successful!"
            print("Server-side code executed successfully, Alpha! 🖥️")
        end)
        if not success then
            StatusLabel.Text = "Status: Backdoor Failed!"
            warn("Server-side code execution failed: " .. tostring(result))
        end
    end)

    print("Backdoor Scanner category loaded.")
end)
...
print("Carnality GUI V0.5 (Dev Version) loaded, Alpha! Green look for Delta Executor—overpowered features for devs! 🫆💚")
